        ...
        <>
            ...
            <style jsx global>{`
                ...
                @keyframes orbDrift {
                    ...
                    50% { transform: translate(calc(-50% - 15px), calc(-50% + 25px)); }
                    75% { transform: translate(calc(-50% + 20px), calc(-50% + 10px)); }
                }
                ...
                @keyframes countdownPulse {
                    ...
                    50% { 
                        text-shadow: 0 0 40px rgba(139, 92, 246, 0.8), 0 0 80px rgba(139, 92, 246, 0.4), 0 0 120px rgba(139, 92, 246, 0.1);
                    }
                }
